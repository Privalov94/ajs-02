 ...
 * @returns {Function} The middleware function.
 */
ajs.serve = function (rootDir, locals, opts) {
    return function (req, res, next) {
 ...
 * @param {Function} callback The callback function.
 */
ajs.compileFile = ajs._load = function (filename, opts, callback) {
 ...
 */
ajs.compileFileSync = ajs._loadSync = function (filename, opts) {
    opts = opts || {};
